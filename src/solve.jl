...
function solve(ocp::OptimalControlModel,
  ...
  #return(Solution(ipopt_solution_ad.solution,ctds.ocp,ctds.parameter_dimension,grid_size_fine,grid_size_coarse,ctds.time_size))
...
#   grid_size_fine::Integer=__grid_size_fine(),
#   grid_size_coarse::Interger=__grid_size_coarse(grid_size_fine),
#   print_level::Integer=__print_level_ipopt(),
#   mu_strategy::String=__mu_strategy_ipopt(),
#   kwargs...)
...
#   if :adnlp in method
#       ctd = CTDirectShooting_data(ocp, grid_size, init)
